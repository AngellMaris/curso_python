...
Original file is located at
    https://colab.research.google.com/drive/1pwternuX_kKnTw3H3CgV8mjr9JQmbbj_
"""
...
print("Salario : R$%6.2f \nImposto a Pagar : R$%6.2f" % (salario,salario))
...
def calcular (salario):
  tabela_ir = [
     ...
     {"faixa" : (4661.69,float("inf")), "aliquota": 27.5,"deducao":869.36}
  ]
